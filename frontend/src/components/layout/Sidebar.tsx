  ...
  return (
    <div style={{
      ...
      <div style={{ padding: '1.5rem 1.35rem', display: 'flex', alignItems: 'center', gap: '0.85rem' }}>
        <div style={{ background: 'var(--primary)', padding: '0.5rem', borderRadius: '0.4rem', display: 'flex' }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '0 0.85rem', display: 'flex', flexDirection: 'column', gap: '0.3rem' }}>
        <NavLink to="/dashboard" style={({ isActive }) => navItemStyle(isActive)}>
          {({ isActive }) => (
            <>
              <LayoutDashboard size={18} color={isActive ? '#FFFFFF' : 'var(--text-secondary)'} /> Overview
            </>
          )}
        </NavLink>
        <NavLink to="/employees" style={({ isActive }) => navItemStyle(isActive)}>
          {({ isActive }) => (
            <>
              <Users size={18} color={isActive ? '#FFFFFF' : 'var(--text-secondary)'} /> Employees
            </>
          )}
        </NavLink>
        <NavLink to="/attendance" style={({ isActive }) => navItemStyle(isActive)}>
          {({ isActive }) => (
            <>
              <Clock size={18} color={isActive ? '#FFFFFF' : 'var(--text-secondary)'} /> Attendance
            </>
          )}
        </NavLink>
        <NavLink to="/leave" style={({ isActive }) => navItemStyle(isActive)}>
          {({ isActive }) => (
            <>
              <Calendar size={18} color={isActive ? '#FFFFFF' : 'var(--text-secondary)'} /> Leave & Absence
            </>
          )}
        </NavLink>
        <NavLink to="/payroll" style={({ isActive }) => navItemStyle(isActive)}>
          {({ isActive }) => (
            <>
              <DollarSign size={18} color={isActive ? '#FFFFFF' : 'var(--text-secondary)'} /> Payroll
            </>
          )}
        </NavLink>
          ...
          {({ isActive }) => (
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                <Activity size={18} color={isActive ? '#FFFFFF' : 'var(--text-secondary)'} /> Command Center
              </div>
              <span className="animate-live-pulse" style={{ background: isActive ? '#FFFFFF' : 'var(--danger)', color: isActive ? 'var(--primary)' : '#FFFFFF', fontSize: '0.65rem', padding: '0.12rem 0.45rem', borderRadius: '0.2rem', fontWeight: 800 }}>LIVE</span>
            </div>
          )}
        </NavLink>
        ...
        <NavLink to="/intelligence" style={({ isActive }) => navItemStyle(isActive)}>
          {({ isActive }) => (
            <>
              <AlertTriangle size={18} color={isActive ? '#FFFFFF' : 'var(--text-secondary)'} /> Risk Analysis
            </>
          )}
        </NavLink>
        ...
        <NavLink to="/simulator" style={({ isActive }) => navItemStyle(isActive)}>
          {({ isActive }) => (
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                <Zap size={18} color={isActive ? '#FFFFFF' : 'var(--text-secondary)'} /> What-If Simulator
              </div>
              <span style={{ background: isActive ? '#FFFFFF' : 'var(--primary-soft)', color: isActive ? 'var(--primary)' : 'var(--primary)', border: '1px solid var(--primary)', fontSize: '0.65rem', padding: '0.12rem 0.45rem', borderRadius: '0.2rem', fontWeight: 800 }}>AI</span>
            </div>
          )}
        </NavLink>
        ...
        <NavLink to="/copilot" style={({ isActive }) => navItemStyle(isActive)}>
          {({ isActive }) => (
            <>
              <Bot size={18} color={isActive ? '#FFFFFF' : 'var(--text-secondary)'} /> HR Copilot
            </>
          )}
        </NavLink>
        ...
        <NavLink to="/traces" style={({ isActive }) => navItemStyle(isActive)}>
          {({ isActive }) => (
            <>
              <FileText size={18} color={isActive ? '#FFFFFF' : 'var(--text-secondary)'} /> Decision Traces
            </>
          )}
        </NavLink>
        ...
        <NavLink to="/audit" style={({ isActive }) => navItemStyle(isActive)}>
          {({ isActive }) => (
            <>
              <Shield size={18} color={isActive ? '#FFFFFF' : 'var(--text-secondary)'} /> Security & Audit
            </>
          )}
        </NavLink>
      </div>
      ...
      <div style={{ padding: '1rem 1.25rem', borderTop: '1px solid var(--divider)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'var(--surface)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          <div style={{ width: '34px', height: '34px', borderRadius: '0.4rem', background: 'var(--primary)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#FFFFFF', fontWeight: 900, fontSize: '0.85rem' }}>
            AD
          </div>
          <div>
