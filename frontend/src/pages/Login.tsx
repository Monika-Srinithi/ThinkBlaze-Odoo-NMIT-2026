...
export default function Login() {
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', width: '100vw', background: 'var(--bg-base)' }}>
      {/* Left side branding */}
      <div style={{ flex: 1, padding: '4rem', display: 'flex', flexDirection: 'column', justifyContent: 'center', background: 'linear-gradient(135deg, rgba(16,185,129,0.08) 0%, rgba(7,8,13,1) 100%)', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
            <div style={{ background: 'linear-gradient(135deg, #10b981 0%, #059669 100%)', padding: '1rem', borderRadius: '1rem', display: 'flex', boxShadow: '0 0 30px var(--primary-glow)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.75rem' }}>
            {[
              ...
              <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '1.25rem' }}>
                ...
                <div>
                  <h3 style={{ margin: '0 0 0.2rem 0', fontSize: '1.1rem', fontWeight: 700 }}>{feature.title}</h3>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '3rem' }}>
        <div className="glass-panel-glow" style={{ width: '100%', maxWidth: '420px', padding: '3rem' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.4rem', background: 'rgba(16,185,129,0.12)', color: 'var(--primary)', padding: '0.3rem 0.8rem', borderRadius: '2rem', fontSize: '0.75rem', fontWeight: 700, marginBottom: '1rem' }}>
